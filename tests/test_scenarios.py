...
def test_scenario_01(fs, reference, A002R2EC):
    ...
    runner = CliRunner()
    result = runner.invoke(verify.verify, ['/travel_01/A002R2EC'])
...
def test_scenario_02(fs, reference, A002R2EC):
    ...
    with freeze_time("2020-01-17 14:30:00"):
        ...
        result = runner.invoke(verify.verify, ['/file_server/A002R2EC'])
        assert result.exit_code == 0
...
def test_scenario_03(fs, reference, A002R2EC):
    ...
    with freeze_time("2020-01-17 14:30:00"):
        ...
        result = runner.invoke(verify.verify, ['-h', 'MD5', '/file_server/A002R2EC'])
        assert result.exit_code == 0
...
def test_scenario_05(fs, reference, A002R2EC, A003R2EC):
    ...
    runner = CliRunner()
    result = runner.invoke(verify.verify, ['/travel_01/Reels/A002R2EC'])
    assert result.exit_code == 0
    ...
    runner = CliRunner()
    result = runner.invoke(verify.verify, ['/travel_01/Reels/A003R2EC'])
    assert result.exit_code == 0
    ...
    with freeze_time("2020-01-17 14:30:00"):
        ...
        runner = CliRunner()
        result = runner.invoke(verify.verify, ['/file_server/Reels'])
        assert result.exit_code == 0
