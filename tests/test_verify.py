...
def test_directory_verify_detect_changes(fs, simple_mhl_history):
	...
	result = runner.invoke(ascmhl.commands.verify, ['-v', '-dh', '/root/'])
	assert "ERROR: content hash mismatch   for A old xxh128: 4c8e69c311b21a0a1b3e54fac069fdab, new xxh128: 26f0b33a4f7de085f5128d6972ced366 (generation 0002)" in result.output
	...
	result = runner.invoke(ascmhl.commands.verify, ['-v', '-dh', '/root/'])
	assert "ERROR: structure hash mismatch for B old xxh128: c523dc4f6078c7617bf958873544aab6, new xxh128: 5c3a07fb32c5180f763d29d762f5c746 (generation 0002)" in result.output
	assert result.exit_code == 15
